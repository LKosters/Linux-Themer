...
function TerminalColumn({ active }: { active: boolean }) {
  ...
  const lines = [
    ...
    { prompt: false, text: "  Host: ThinkPad X1 Carbon" },
    { prompt: false, text: "  Kernel: 6.12.7-arch1-1" },
    { prompt: false, text: "  WM: niri (Wayland)" },
    { prompt: false, text: "  Shell: fish 3.7" },
    { prompt: false, text: "  Terminal: alacritty" },
    { prompt: false, text: "  Packages: 1142 (pacman)" },
    { prompt: false, text: "  Memory: 2.8G / 16G" },
    { prompt: true, text: "" },
  ]

  return (
    <div className="flex flex-col overflow-hidden h-full" style={containerStyle}>
      <div className="flex items-center justify-between px-2.5 py-1 shrink-0" style={{ backgroundColor: blurBg, borderBottom: `1px solid ${theme.barText}10` }}>
...
function EditorColumn({ active }: { active: boolean }) {
  ...
  const lines = [
    ...
    { num: 5, content: [{ text: "struct ", c: "kw" }, { text: "Column", c: "fn" }, { text: " {", c: "p" }] },
    { num: 6, content: [{ text: "    width: ", c: "p" }, { text: "f64", c: "kw" }, { text: ",", c: "p" }] },
    { num: 7, content: [{ text: "    is_active: ", c: "p" }, { text: "bool", c: "kw" }, { text: ",", c: "p" }] },
    { num: 8, content: [{ text: "}", c: "p" }] },
    { num: 9, content: [] },
    { num: 10, content: [{ text: "fn ", c: "kw" }, { text: "scroll_columns", c: "fn" }, { text: "() {", c: "p" }] },
    { num: 11, content: [{ text: '    let cols = Column::default();', c: "p" }] },
    { num: 12, content: [{ text: '    println!("', c: "p" }, { text: "scrolling", c: "str" }, { text: '");', c: "p" }] },
    { num: 13, content: [{ text: "}", c: "p" }] },
  ]
